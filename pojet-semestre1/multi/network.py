...
class Network:
    ...
    def requestConnection(IP, port):
        ...
        """
        command = f"./multi/network_manager {IP} {port} py_to_c c_to_py {Network.uuid_player}&"
        os.system(command)
    ...
    def processConnectionResponse(message):
        ...
        dataDictionnary["gridSize"] = argList[0]
        ...
        for i in range(1, len(argList)):
            ...
            obj = {}
            obj["id"] = data[1]
            obj["jobProperty"] = data[2]
            obj["networkProperty"] = data[3]
            obj["x"] = data[4]
            obj["y"] = data[5]
            obj["energy"] = data[6]
